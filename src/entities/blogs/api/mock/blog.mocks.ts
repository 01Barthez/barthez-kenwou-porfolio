...
*(GIF of ArgoCD + Helm live deployment coming in the published version)*
  `,
    "image": "https://images.unsplash.com/photo-1605379399843-5870eea9b3b3?w=1200&h=600&fit=crop",
    "category": "DevOps",
    "date": "2026-04-19",
    "readTime": "58 min",
    "author": "Barthez Kenwou",
  ...
  {
    "id": "13",
    "titleFr": "How I Secure a Linux Server (Step-by-Step Hardening Guide) – De VPS Vierge à Forteresse Complète",
    "titleEn": "How I Secure a Linux Server (Step-by-Step Hardening Guide) – From Fresh VPS to Complete Fortress",
