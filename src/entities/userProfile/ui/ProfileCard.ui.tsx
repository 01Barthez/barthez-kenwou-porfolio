  ...
  return (
    <div className="relative glass rounded-md p-0 border border-border">
      <div className="relative mb-2 max-h-64 overflow-hidden">
        ...
        />
        <div className="absolute cursor-default bottom-0 right-0 group z-20">
          {/* Glowing Aura */}
          <div className="absolute inset-0 bg-gradient-to-r from-primary to-primary/70 rounded-md blur-md opacity-40 group-hover:opacity-100 transition-opacity duration-500 animate-pulse" />

          {/* Premium Badge Glass Structure */}
          <div className="h-5 w-36 relative flex items-center gap-2 bg-gradient-to-br from-primary to-primary/70 text-white px-2 py-0.5 rounded-md font-mono text-xs font-bold border border-white/20 shadow-lg transform group-hover:scale-102 group-hover:-translate-y-1 transition-all duration-300">
          </div>
        </div>
      </div>
