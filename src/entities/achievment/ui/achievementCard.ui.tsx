...
export const AchievmentCard: React.FC<{ Achievment: IAchievement }> = ({ Achievment }) => {
  ...
  return (
    <div className="text-center p-4 rounded-xl bg-linear-to-br from-primary/5 to-accent/5 border border-primary/10 hover:border-primary/30 transition-colors">
