    ...
    <article className="prose prose-sm md:prose-base dark:prose-invert max-w-none mb-10 overflow-hidden">
      <div
        ...
        dangerouslySetInnerHTML={{
          __html: content
            .replace(/# (.*)/g, '<h1 class="text-lg md:text-xl font-extrabold text-foreground mt-10 mb-5 border-l-4 border-primary pl-4">$1</h1>')
            ...
            .replace(/- (.*)/g, '<li class="ml-6 flex items-start gap-1 mb-0"><span class="text-primary mt-0">•</span><span>$1</span></li>'),
        }}
      />
    </article>
  );
