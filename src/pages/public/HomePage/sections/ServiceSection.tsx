...
export const ServiceSection: React.FC = () => {
  ...
  return (
    <section className="px-4 md:px-10 lg:px-14 py-24 relative z-10 overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="flex flex-col items-start space-y-8 animate-fade-in">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-sm max-w-xl text-center md:!text-left leading-relaxed">
              {isFr
          ...
          <Link
            to="/services"
            className="group mx-auto md:mx-0 inline-flex items-center text-sm gap-3 px-4 py-1.5 rounded-lg bg-primary text-primary-foreground font-medium border border-primary/20 hover:scale-95 active:scale-95 transition-all duration-300"
          >
