...
export const Terminal = ({
  ...
  const content = (
    <div
      ref={containerRef}
      className={cn(
        "border-border bg-background z-0 h-full w-full max-w-lg rounded-md border flex flex-col",
        className
      )}
    >
      <div className="border-border flex flex-row shrink-0 gap-x-1.5 md:gap-x-2 border-b p-3 md:p-4">
      ...
      <pre className="p-3 md:p-5 flex-1 overflow-x-auto whitespace-pre-wrap break-words">
